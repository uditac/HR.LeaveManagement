            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveRequest", b =>
                {
                    ...
                    b.Property<DateTime>("ReqquestedTinme")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 8, 14, 20, 27, 33, 186, DateTimeKind.Local).AddTicks(7888),
                            DateModified = new DateTime(2023, 8, 14, 20, 27, 33, 186, DateTimeKind.Local).AddTicks(7945),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
